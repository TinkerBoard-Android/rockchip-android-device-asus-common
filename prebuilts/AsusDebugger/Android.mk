...
else ifeq ($(TARGET_PRODUCT), $(filter $(TARGET_PRODUCT),Tinker_Board_3N Sanden_VM Sanden_CM Tinker_Board_3))
...
ifeq ($(TARGET_PRODUCT),CN_Zenbo)
	...
	ifeq ($(TARGET_BUILD_VARIANT),user)
        ...
        ifeq ($(TARGET_BUILD_VARIANT),user)
                ...
                LOCAL_SRC_FILES := config/Tinker_Board_3N/debug/$(LOCAL_MODULE)
        endif
